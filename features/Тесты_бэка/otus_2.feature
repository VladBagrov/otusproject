...
Сценарий: я создаю продажу подарочного сертификата (бэк)
	И В командном интерфейсе я выбираю 'Отус' 'Продажи'
	Тогда открылось окно 'Продажи товара'
	И я нажимаю на кнопку с именем 'ФормаСоздать'
	Тогда открылось окно 'Продажа товара (создание)'
	...
	И я нажимаю на кнопку с именем 'НоваяКарта'
	Тогда открылось окно 'Отус новая карта'
	И в поле с именем 'Фамилия' я ввожу текст 'под'
	И я перехожу к следующему реквизиту
	И в поле с именем 'Имя' я ввожу текст 'подарков'
	И я перехожу к следующему реквизиту
	И в поле с именем 'Телефон' я ввожу текст '999'
	И я изменяю флаг с именем 'ПодарочныйСертификат'
	...
	Тогда открылось окно 'Движения документа (Горизонтально)'
	И я нажимаю на кнопку с именем 'СформироватьОтчет'
	И Табличный документ "ОтчетТабличныйДокумент" равен макету "ДвиженияРасходТовара_ПодарочныйСерт" по шаблону
	И Я закрываю окно 'Движения документа (Горизонтально)'
	Тогда открылось окно 'Продажа * от *'
	И я нажимаю на кнопку с именем 'ФормаПровестиИЗакрыть'
	И я жду закрытия окна 'Продажа * от *' в течение 20 секунд
